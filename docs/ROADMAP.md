...
(build profiles; PN 2.15 … 2.23 — run counter, About values, SPEED partner row, known-length NVP calibration
before or after the measurement, a Cable Test that says "Not connected" instead of guessing and shows its
readings — all on the unit 2026-09-21, PN 2.23 is the release) —
