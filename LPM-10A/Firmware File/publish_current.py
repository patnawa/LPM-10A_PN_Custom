"""Copy the current TX/RX release files from experimental/ to this folder and rewrite SHA256SUMS.txt.
    ...
    python publish_current.py LPM-10A-TX_PN2.14-tone-recovery.bin APP_LPM-10RX_PN1.23-mains-tone-update.bin
"""
import hashlib
import os
import shutil
...
names = sys.argv[1:] or ["LPM-10A-TX_PN2.14-tone-recovery.bin", "APP_LPM-10RX_PN1.23-mains-tone-update.bin"]
