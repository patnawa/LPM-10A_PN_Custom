...
`SHA256SUMS.txt` has both checksums; `TX-PN2.26-README.txt` and `RX-PN1.23-README.txt` say what each build
...
| `archive/` | earlier release copies and their per-version notes (TX PN 2.4–2.9, 2.14, 2.20, 2.21, 2.23, RX PN 1.0–1.8) — history only |
